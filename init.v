...
fn init_images(mut app App) {
	...
	$if android {
		...
		app.pawn_white = app.gg.create_image_from_byte_array(pawn_white) or { panic(err) }
		app.knight_white = app.gg.create_image_from_byte_array(knight_white) or { panic(err) }
		app.bishop_white = app.gg.create_image_from_byte_array(bishop_white) or { panic(err) }
		app.rook_white = app.gg.create_image_from_byte_array(rook_white) or { panic(err) }
		app.queen_white = app.gg.create_image_from_byte_array(queen_white) or { panic(err) }
		app.king_white = app.gg.create_image_from_byte_array(king_white) or { panic(err) }
		...
		app.pawn_black = app.gg.create_image_from_byte_array(pawn_black) or { panic(err) }
		app.knight_black = app.gg.create_image_from_byte_array(knight_black) or { panic(err) }
		app.bishop_black = app.gg.create_image_from_byte_array(bishop_black) or { panic(err) }
		app.rook_black = app.gg.create_image_from_byte_array(rook_black) or { panic(err) }
		app.queen_black = app.gg.create_image_from_byte_array(queen_black) or { panic(err) }
		app.king_black = app.gg.create_image_from_byte_array(king_black) or { panic(err) }
		menu_background := os.read_apk_asset(app.theme.path2background_android) or { panic(err) }
		app.m_background = app.gg.create_image_from_byte_array(menu_background) or { panic(err) }
	} $else {
